  ...
  return (
    <section className="relative bg-navy text-paper overflow-hidden py-16 md:py-24">
      ...
      <div className="relative mx-auto max-w-4xl px-5 md:px-8 text-center">
        <p className="text-xs uppercase tracking-[0.22em] text-amber mb-5 animate-fade-up">
          Siap bergabung?
        </p>
        <h2
        ...
        >
          Mulai dari sini dan saksikan <br />
          <em className="not-italic text-amber">masa depanmu mekar.</em>
        </h2>
