        ...
        <table className="w-full text-sm">
          <thead className="bg-paper-soft">
            <tr>
              ...
              <SortTh col="eyebrow"    label="Slide" current={sort} dir={dir} href={sortHrefs.eyebrow} />
            ...
            {rows.map((r) => (
              ...
              >
                ...
                <td className="p-3 align-middle">
                  <p className="text-[11px] uppercase tracking-widest text-muted mb-0.5">{r.eyebrow || "—"}</p>
                ...
                <td className="p-3 align-middle">
                  <div className="flex items-center gap-1.5 justify-end">
                    ...
                    <Link href={`/admin/hero-banner/${r.id}/edit`} className="h-8 px-3 rounded-full border border-black/10 text-xs font-medium hover:bg-paper-soft hover:border-navy transition-colors inline-flex items-center">
                      Edit
                    </Link>
                    ...
                    <DeleteButton
                      ...
                      description={`Slide "${r.eyebrow || r.head?.replace(/\*/g, "") || r.id}" akan dihapus permanen dan tidak bisa dipulihkan.`}
            ...
            {rows.length === 0 && (
              <tr>
                <td colSpan={6} className="p-8 text-center text-sm text-muted">
                  {search ? `Tidak ada slide dengan kata kunci "${search}".` : "Belum ada slide hero."}
                </td>
              </tr>
            )}
          </tbody>
