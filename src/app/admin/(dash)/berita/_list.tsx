...
export function BeritaList({
  ...
  function sortHref(col: SortCol) {
    ...
    if (col === "published_at") p.delete("sort"); else p.set("sort", col);
        ...
        <table className="w-full text-sm">
          <thead className="bg-paper-soft">
            <tr>
              ...
              <SortTh col="title" label="Judul" current={sort} dir={dir} href={sortHref("title")} />
              <SortTh col="tag" label="Tag" current={sort} dir={dir} href={sortHref("tag")} className="hidden md:table-cell" />
              <th className="text-left p-3 text-[10px] uppercase tracking-widest text-muted font-medium hidden lg:table-cell">
                Penulis
              </th>
              <SortTh col="published_at" label="Tanggal" current={sort} dir={dir} href={sortHref("published_at")} className="hidden md:table-cell" />
              <SortTh col="status" label="Status" current={sort} dir={dir} href={sortHref("status")} className="hidden sm:table-cell" />
              <th className="p-3" />
            </tr>
          </thead>
          <tbody>
