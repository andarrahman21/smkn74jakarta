  ...
  return (
    <>
      ...
      <section className="bg-paper py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          <div className="mb-12 reveal">
            <p className="text-xs uppercase tracking-[0.22em] text-muted mb-3">Ruang</p>
            <h2 className="font-display headline-section max-w-2xl">Pilihan ruang & kapasitas.</h2>
          </div>
            ...
            {ruang.map((r, i) => (
              ...
              >
                ...
                <div className="mt-auto pt-3 border-t border-current/15 text-sm space-y-1">
                  <p className="flex justify-between"><span className="opacity-70">Kapasitas</span><span>{r.kapasitas}</span></p>
                  <p className="flex justify-between"><span className="opacity-70">Durasi pinjam</span><span>{r.durasi}</span></p>
                </div>
              </article>
            ))}
          </div>
      ...
      <section className="bg-white border-t border-black/5 py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          <div className="mb-12 reveal">
            <p className="text-xs uppercase tracking-[0.22em] text-muted mb-3">Alat</p>
            <h2 className="font-display headline-section max-w-2xl">Alat pendukung kegiatan.</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {alat.map((a, i) => (
              ...
              >
                <p className="text-[10px] uppercase tracking-widest text-amber font-medium mb-3">{a.kategori}</p>
      ...
      <section className="bg-paper py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          <div className="mb-12 reveal">
            <p className="text-xs uppercase tracking-[0.22em] text-muted mb-3">Alur Peminjaman</p>
            <h2 className="font-display headline-section max-w-2xl">Lima langkah saja.</h2>
          </div>
          <ol className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {alur.map((a, i) => (
              <li
                ...
                style={{ animationDelay: `${i * 0.08}s` }}
              >
                <span className="font-display text-3xl text-amber">{a.n}</span>
                <h3 className="font-display text-lg mt-2 mb-2">{a.t}</h3>
                <p className="text-sm text-ink/70 leading-relaxed">{a.d}</p>
              </li>
            ))}
          </ol>
        </div>
      ...
      <section className="bg-white border-t border-black/5 py-14 md:py-20">
        <div className="mx-auto max-w-7xl px-5 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5 reveal">
            ...
            <h2 className="font-display headline-quote mb-4">Yang perlu disepakati.</h2>
            <p className="text-ink/75 leading-relaxed">
              Peminjaman bertujuan menjaga fasilitas tetap optimal untuk semua kegiatan sekolah. Aturan berikut wajib dipatuhi.
            </p>
          </div>
