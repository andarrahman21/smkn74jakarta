      ...
      <section className="bg-paper py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          <div className="mb-12 reveal">
            <p className="text-xs uppercase tracking-[0.22em] text-muted mb-3">Topik</p>
            <h2 className="font-display headline-section max-w-2xl">Telusuri berdasarkan topik.</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {infos.map((c, i) => (
              ...
              >
                ...
                <h3 className="font-display text-xl leading-tight mt-auto">{c.title}</h3>
